...
dependencies {
    ...
    compileOnly("io.github.simplified-dev:annotations:2.6.1")
    annotationProcessor("io.github.simplified-dev:annotations:2.6.1")
    testCompileOnly("io.github.simplified-dev:annotations:2.6.1")
    testAnnotationProcessor("io.github.simplified-dev:annotations:2.6.1")
